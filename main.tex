...
% \usepackage{graphicx}
\begin{table*}[]
\caption{Summary of studies aimed at recognising Emotion Regulation online}
\label{tab:my-table}
...
\begin{tabular}[c]{@{}l@{}}Emotion trajectories\\ in smartphone use: \\ Towards recognizing\\ emotion regulation\\ in the wild {[}15{]}\end{tabular} &
  ...
  NA \\ \hline
\begin{tabular}[c]{@{}l@{}}Benchmarking \\ commercial emotion \\ detection systems \\ using realistic \\ distortions of facial\\ image datasets {[}16{]}\end{tabular} &
  ...
  \begin{tabular}[c]{@{}l@{}}used online \\ datasets \\ (ADFES) {[}17{]}\\ (RaFD) {[}18{]}, and\\  (WSEFEP) {[}19{]}\end{tabular} &
  \begin{tabular}[c]{@{}l@{}}838 pictures in\\ total\end{tabular} &
  NA \\ \hline
\begin{tabular}[c]{@{}l@{}}Behavioural and \\ Physiological Signals-\\ Based Deep Multimodal\\ Approach for Mobile \\ Emotion Recognition {[}20{]}\end{tabular} &
...
\begin{tabular}[c]{@{}l@{}}How Do You Feel \\ Online? Exploiting \\ Smartphone Sensors\\ to Detect Transitory\\ Emotions during Social \\ Media Use {[}21{]}\end{tabular} &
